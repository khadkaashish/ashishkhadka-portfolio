    ...
    <section id="contact" className="py-24 max-w-5xl mx-auto section-padding">
      <div className="border-t border-zinc-200 dark:border-zinc-800 pt-16">
        <p className="font-mono text-xs text-emerald-600 dark:text-emerald-500 uppercase tracking-widest mb-10">
          <span className="text-zinc-300 dark:text-zinc-700 mr-1">07</span> contact
        </p>

        <div className="max-w-lg space-y-6">
          <div>
            <h2 className="font-mono text-2xl text-zinc-900 dark:text-zinc-100 mb-2">get in touch</h2>
          ...
          <a
            ...
            className="group flex items-center gap-3 text-zinc-500 dark:text-zinc-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors"
          >
          ...
          <div className="flex items-center gap-6 pt-2">
            <a
              ...
              className="flex items-center gap-2 font-mono text-xs text-zinc-400 dark:text-zinc-600 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors"
            >
              <Linkedin size={13} />
              linkedin
            </a>
